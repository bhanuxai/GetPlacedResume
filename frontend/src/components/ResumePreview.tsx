...
export const ResumePreview: React.FC<ResumePreviewProps> = ({ rawText }) => {
  ...
  return (
    <div className="w-full bg-white dark:bg-[#12161F] border border-slate-200 dark:border-[#273142] p-6 sm:p-8 rounded-xs transition-colors shadow-sm dark:shadow-none">
      {/* Header */}
      <div className="flex items-center justify-between pb-6 border-b border-slate-200 dark:border-[#273142]">
        <div>
        ...
        <button
          onClick={handleCopy}
          className="flex items-center space-x-1.5 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-[#0A0D12] dark:hover:bg-[#1A202C] border border-slate-300 dark:border-[#273142] text-xs font-mono text-slate-800 dark:text-white rounded-xs transition-colors"
        >
      ...
      <div className="mt-6 bg-slate-50 dark:bg-[#0A0D12] border border-slate-300 dark:border-[#273142] p-5 max-h-[550px] overflow-y-auto transition-colors">
