...
const prepareRenderGraph = async (graph: ReturnType<typeof createRenderGraph>, outputFormat: any) => {
  await Promise.all([
    graph.shardDraw.compile({ colors: [outputFormat as any] }),
    ...
    graph.finishEffect.compile({ colors: [outputFormat as any] }),
