    ...
    <div className="w-full bg-white dark:bg-[#0A0A0A] border border-slate-200 dark:border-[#262626] p-6 sm:p-8 rounded-xs transition-colors shadow-sm dark:shadow-none">
      ...
      <div className="pt-6 space-y-4">
        {recommendations.length === 0 ? (
          <div className="p-8 text-center text-xs text-[#059669] dark:text-[#10B981] font-mono bg-emerald-50 dark:bg-[#000000] border border-[#059669] dark:border-[#10B981]">
            No urgent adjustments detected. Your resume is exceptionally well-aligned.
          </div>
        ) : (
          recommendations.map((rec) => (
            <div key={rec.id} className="bg-slate-50 dark:bg-[#000000] border border-slate-300 dark:border-[#262626] p-5 transition-colors">
                  ...
                  <span
                    className={`px-2 py-0.5 text-[10px] font-mono font-bold uppercase rounded-xs ${
                      rec.priority === 'HIGH'
                        ...
                        : 'bg-blue-50 dark:bg-[#171717] text-[#2563EB] dark:text-[#60A5FA] border border-[#2563EB] dark:border-[#60A5FA]'
                    }`}
                  >
                    {rec.priority} IMPACT
                  </span>
              ...
              <div className="bg-white dark:bg-[#0A0A0A] p-3 border border-slate-300 dark:border-[#262626] flex items-start space-x-2 text-xs text-slate-900 dark:text-white font-mono">
