      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2.5 sm:space-x-3">
          ...
          <button
            ...
            className="p-2 text-slate-600 hover:text-slate-900 dark:text-[#94A3B8] dark:hover:text-white bg-slate-100 hover:bg-slate-200 dark:bg-[#171717] dark:hover:bg-[#1f1f1f] border border-slate-300 dark:border-[#262626] rounded-xs transition-colors"
          ...
          <button
            onClick={onTryDemo}
            className="flex items-center space-x-1.5 px-3 py-2 text-xs sm:text-sm font-medium text-slate-800 dark:text-[#F8FAFC] bg-slate-100 hover:bg-slate-200 dark:bg-[#171717] dark:hover:bg-[#1f1f1f] border border-slate-300 dark:border-[#262626] rounded-xs transition-colors"
          >
