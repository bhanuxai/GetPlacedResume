...
export const EvidenceCard: React.FC<EvidenceCardProps> = ({ snippets, explanation }) => {
  if (snippets.length === 0) {
    return (
      <div className="bg-slate-100 dark:bg-[#000000] border border-slate-300 dark:border-[#262626] p-3 text-xs text-slate-600 dark:text-[#94A3B8] font-mono">
  ...
  return (
    <div className="space-y-2">
      {snippets.map((snippet, idx) => (
        <div
          key={idx}
          className="bg-white dark:bg-[#000000] border-l-2 border-l-[#2563EB] border-t border-r border-b border-slate-300 dark:border-[#262626] p-3 text-xs text-slate-800 dark:text-[#F8FAFC] flex items-start space-x-2.5 shadow-none"
        >
