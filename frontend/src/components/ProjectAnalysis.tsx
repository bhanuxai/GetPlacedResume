      ...
      <div className="pt-6 space-y-6">
        {projects.length === 0 ? (
          ...
          projects.map((proj, idx) => (
            <div key={idx} className="bg-slate-50 dark:bg-[#0A0D12] border border-slate-300 dark:border-[#273142] p-5 transition-colors">
              
              {/* Project Title Bar */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-200 dark:border-[#273142]">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-white dark:bg-[#1A202C] border border-slate-300 dark:border-[#273142] flex items-center justify-center text-[#2563EB]">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="h-6 w-px bg-slate-200 dark:bg-[#273142]" />
                  <div>
                    <span
              ...
              <div className="py-3 flex flex-wrap items-center gap-1.5 border-b border-slate-200 dark:border-[#1E2633]">
                <span className="text-[10px] font-mono text-slate-600 dark:text-[#94A3B8] mr-1">TECH STACK:</span>
                {proj.technologies.map((t, tIdx) => (
                  <span
                    key={tIdx}
                    className="px-2 py-0.5 text-[11px] font-mono bg-white dark:bg-[#1A202C] text-slate-800 dark:text-[#F8FAFC] border border-slate-300 dark:border-[#273142]"
                  >
                    {t}
                  </span>
                ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 text-xs">
                <div className="bg-white dark:bg-[#12161F] p-3 border border-slate-300 dark:border-[#273142]">
              ...
              <div className="mt-4 bg-white dark:bg-[#12161F] border border-slate-300 dark:border-[#273142] p-3.5">
